...
.text-whitedrop{
	font-size:20px;
	color:#666;
	text-shadow: 0px -1px 0px rgba(255,255,255,10);
...
<table id="Table_01" width="170" height="594" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
		<td height="125" align="right" valign="middle" class="text-whitedrop"><a href="https://www.facebook.com/groups/1485209575036458/" target="_blank"><img src="images/fa_03.png" alt=""  border="0"></a></td>
	</tr>
	<!--<tr>
		<td valign="middle">
        <iframe src="http://<?php echo $iphost ?>/competency_master/application/hr3/tool_competency/statistic_graph_dd_mainpage_black.php" width="170" height="179" scrolling="no" frameborder="0"></iframe>
			<img src="images/btn_07_cut.png" alt=""></td>
	</tr> -->
